...
void MainWindow::ConnectMenuBar()
{
  ...
  connect(m_menu_bar, &MenuBar::ThreeDScreenshot, this, &MainWindow::ThreeDScreenShot);
...
void MainWindow::ConnectHotkeys()
{
  ...
  connect(m_hotkey_scheduler, &HotkeyScheduler::ThreeDScreenShotHotkey, this,
          &MainWindow::ThreeDScreenShot);
...
void MainWindow::ThreeDScreenShot()
{
